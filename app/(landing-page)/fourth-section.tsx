...
const tabs = [
    {
        ...
        header: "Visualize, sort, and filter any way you want.",
        subheading: " show only tasks assigned to you, or item marked as urgent. Break down project in the way is that most helpful to you.",
        images: [
        ...
        <>
            ...
            >
             ...
             mx-auto
                ...
                <div className={cn(
                    "flex items-center justify-center text-xl xl:text-2xl xl:py-10 pt-6 px-8 md:px-8  md:w-2/3 xl:w-1/2 text-center", font.className
                )}>
                    &quot;Sleek adapts to your needs. It&apos;s as minimal or as powerful
          as you need it to be.&quot;
                ...
                <div className="items-center flex justify-center flex-col">
                    ...
                    <div className="m text-center">
                        <div className="text-sm font-medium pt-4">MARSCIELLO</div>
                        <div className="text-sm">Marketing Director, MARSHIELO Software</div>
                    </div>
                </div>
            </div>
        </>
