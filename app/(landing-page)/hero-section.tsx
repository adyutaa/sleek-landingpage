...
const tabs = [
    {
        ...
        desription: "Ask literally anything. Sleek will answer.",
        more: (
    ...
    {
        icon: (
            <PiSparkleLight className="text-3xl mr-2 text-red-600 bg-purple-100 p-1 rounded-md" />
        ),
        title: "Wikis",
        feature: "Now with Q&A",
        desription: "Centralize your knowledge",
        more: (
            <div className="text-red-600 flex items-center">
                Learn more <PiArrowRight className="ml-1 text-sm" />
            </div>
        ),
         image: "/assets/SitReadingDoodle.svg"
    },
    {
        icon: (
            <PiSparkleLight className="text-3xl mr-2 text-blue-600 bg-purple-100 p-1 rounded-md" />
        ),
        title: "Projects",
        feature: "Now with Q&A",
        desription: "Manage complex project without chaos",
        more: (
    ...
    {
        icon: (
            <PiSparkleLight className="text-3xl mr-2 text-yellow-600 bg-purple-100 p-1 rounded-md" />
        ),
        title: "Docs",
        feature: "Now with Q&A",
        desription: "Simple, poweful, and beautiful with next gen docs",
        more: (
...
const Hero = () => {
    ...
    return ( 
        <div className="md: items-center flex flex-col">
            <div className="font-medium 2xl:w-1/3 md:w-2/3 xl:w-1/2 lg:px-0 px-8 text-5xl xl:text-6xl     
            flex
            justify-center
            xl:font-medium
            xl:pt-14
            text-center 
            pt-6 ">
                Write, plan, share. With AI on your side.
            </div>
            <p className="text-2xl
            pt-4
            text-center
            w-2/3
            mx-auto">Sleek is the connected workspace where better, faster work happens.</p>
            ...
            <div className="pt-10 xl:pt-20 items-center justify-center">
                <Image src={"/assets/CoffeeDoddle.svg"} alt="hero-image" width={5000} height={5000}
                className="flex items-center justify-center mx-auto w-80 xl:w-100"/>
            </div>
            {isSmallScreen ? (
          <div className="px-8">
              ...
              >
                <div className="px-4">
                  <div className="flex items-center">
                    <div>{tab.icon}</div>
                    <div className="text-2xl font-medium">{tab.title}</div>
