...
const tabs = [
  ...
  },
  {
    ...
    userName: "Daniel Caesar",
    userHandle : "@valentina",
    userText: (
  ...
  {
    profile: "/assets/DoogieDoodle.svg",
    userName: "Grace Nevia",
    userHandle : "@gracenevia",
    userText: (
      <div className="md:mt-6">
      <span className="text-sky-500">@sleeksoftware </span>
        ...
        <>
            <div className="pt-20  xl:pt-24 flex justify-center items-center flex-col">
                <div className="text-3xl w-3/4 xl:text-5xl font-medium xl:w-1/2 text-center">
                    Join the global movement. Unleash your creativity.
                </div>
